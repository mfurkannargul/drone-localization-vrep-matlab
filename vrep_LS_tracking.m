...
if (clientID > -1)
    ...
    [returnCode, position0] = vrep.simxGetObjectPosition(clientID,anchor0,-1,vrep.simx_opmode_streaming);
    [returnCode, position1] = vrep.simxGetObjectPosition(clientID,anchor1,-1,vrep.simx_opmode_streaming);
    [returnCode, position2] = vrep.simxGetObjectPosition(clientID,anchor2,-1,vrep.simx_opmode_streaming);
    %position = [];
    ...
    while(1)
        for t=2:2:60
            ...
            plot(XYZcoordinate(:,1),XYZcoordinate(:,2),'k+','MarkerSize',14,'LineWidth',1.7)
            ...
            elseif (t==54)
                target_pos = vrep.simxSetObjectPosition(clientID, target, -1, [1.25, 1.35, z_current], vrep.simx_opmode_blocking);
            elseif (t==56)
